    ...
    'line-plots': {
      ...
      sections: [
        ...
        },
        {
          type: 'definitions',
          items: [
            { term: '🎨 SVG', definition: 'Vector graphics format. Scales perfectly for any size, ideal for publications and LaTeX documents. Editable in vector graphics software.' },
            { term: '🖼️ PNG', definition: 'Raster image at high resolution (2x). Best for presentations, web pages, and quick sharing.' },
            { term: '📊 CSV', definition: 'Comma-separated values with SNR and E₀ columns. Import into Excel, MATLAB, Python, or any data analysis tool.' },
            { term: '📋 JSON', definition: 'Complete plot data including all parameters, series data, and metadata. Perfect for reproducibility or reimporting into EPCalculator.' }
          ]
        },
        {
          type: 'code',
          language: 'csv',
          text: '# Example CSV output:\nSNR_dB,E0_4PSK,E0_8PSK\n0,0.142,0.089\n2,0.298,0.195\n4,0.471,0.324\n...'
        },
        {
          type: 'try-it',
