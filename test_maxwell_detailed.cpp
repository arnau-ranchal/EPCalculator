// Detailed test of C++ Maxwell-Boltzmann implementation
...
// Forward declarations from functions.cpp
...
// We need to access Q_mat - let's declare an external function to get Q values
extern "C" {
    // These are in the Eigen namespace but we can access the raw data
    #include <Eigen/Dense>
